...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(controllers::paskibraka_controller::sync_capaska_users)
            .service(controllers::paskibraka_controller::get_paskibraka_profile)
            .service(controllers::paskibraka_controller::get_physical_records)
            .service(controllers::paskibraka_controller::add_physical_record)
            .service(controllers::paskibraka_controller::get_paskibraka_tugas)
            .service(controllers::paskibraka_controller::create_or_update_tugas)
            .service(controllers::paskibraka_controller::delete_tugas)
            .service(controllers::paskibraka_controller::get_paskibraka_informasi)
            .service(controllers::paskibraka_controller::create_informasi)
            .service(controllers::paskibraka_controller::delete_informasi)
            .service(controllers::paskibraka_controller::upload_pengumpulan_tugas)
            .service(controllers::paskibraka_controller::get_pengumpulan_tugas)
            .service(controllers::paskibraka_controller::get_penilaian_paskibraka)
            .service(controllers::paskibraka_controller::submit_penilaian)
            .service(controllers::paskibraka_controller::update_paskibraka_profile)
            .service(controllers::paskibraka_controller::change_paskibraka_password)
            // sipena
